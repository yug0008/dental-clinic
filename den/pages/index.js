...
<section className="py-8 md:py-8 bg-white relative overflow-hidden">
        ...
        <section className="py-10 bg-[#0194d0] rounded-lg ">
          <div className="container-custom text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+15592444277" className="btn-secondary bg-[#0194d0] hover:bg-navy-900 text-white border-white border-3 text-lg px-8 py-4">
  ...
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2632.9103617546953!2d-119.82821486743198!3d36.80817801734005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x809467c8eeffaa13%3A0xeec9d2afdf319e3b!2s1761%20W%20Shaw%20Ave%20%23%20101%2C%20Fresno%2C%20CA%2093711%2C%20USA!5e1!3m2!1sen!2sin!4v1771141262010!5m2!1sen!2sin"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">761 W Shaw Ave<br />Fresno, CA 93711</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <a href="tel:+15592444277" className="text-gray-600 hover:text-blue-500">+1 559-244-4277</a>
                    </div>
                  </div>
