...
export default function Footer() {
  ...
  return (
    <footer className="bg-white relative overflow-hidden">
      {/* Top Gradient Border */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#0194d0] via-[#01d09e] to-[#0194d0]"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="mt-6 flex items-center gap-4">
              <div>
                <div className="text-2xl font-bold text-[#0194d0]">15+</div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-[#0194d0]/5 transition-all group">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">761 W Shaw Ave # 101<br />Fresno, CA 93711, US</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-[#0194d0]/5 transition-all group">
                ...
                <div>
                  ...
                  <a href="tel:+15592444277" className="text-gray-600 hover:text-[#0194d0] text-sm block">
                    +1 559-244-4277
                  </a>
        ...
        <div className="border-t border-gray-200 mt-16 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {currentYear} Rio Family Dental. All rights reserved.
            </p>
