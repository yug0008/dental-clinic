            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-[#0194d0]/5 transition-all group">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">7525 N Cedar Ave<br />Fresno, CA 93711, USA</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-[#0194d0]/5 transition-all group">
                ...
                <div>
                  ...
                  <a href="tel:+15594321300" className="text-gray-600 hover:text-[#0194d0] text-sm block">
                   +1 559-432-1300
                  </a>
        ...
        <div className="border-t border-gray-200 mt-16 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {currentYear} Forester Dental. All rights reserved.
            </p>
