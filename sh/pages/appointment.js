...
function QuickContactCard({ mobile = false }) {
  const address = "7903 Silicon Heights, Colorado Springs, CO, USA";
  const phone = "(719) 354-2900";
  ...
  return (
    <div className={`bg-white rounded-2xl md:rounded-3xl shadow-xl p-5 md:p-8 border border-gray-100 ${!mobile && 'sticky top-24'}`}>
      ...
      <div className="space-y-3 md:space-y-4">
        ...
        <a href="https://wa.me/7193542900" className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-gray-50 rounded-xl md:rounded-2xl hover:bg-[#0194d0]/5 transition-all group">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-[#0194d0]/10 rounded-lg md:rounded-xl flex items-center justify-center group-hover:bg-[#0194d0] transition-colors flex-shrink-0">
        ...
        <a href="mailto:Info@JAMIM.Dental" className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-gray-50 rounded-xl md:rounded-2xl hover:bg-[#0194d0]/5 transition-all group">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-[#0194d0]/10 rounded-lg md:rounded-xl flex items-center justify-center group-hover:bg-[#0194d0] transition-colors flex-shrink-0">
          ...
          <div className="min-w-0">
            ...
            <p className="font-bold text-gray-900 text-sm md:text-base truncate">Info@JAMIM.Dental</p>
          </div>
        </a>
