        ...
        <>
          ...
          <div className="flex items-center gap-2 md:gap-3 text-white bg-white/10 rounded-lg md:rounded-xl p-3 md:p-4">
            ...
            <div>
              ...
              <p className="text-base md:text-lg lg:text-xl font-bold">(719) 354-2900</p>
            </div>
          </div>
        </>
      ),
          ...
          <div className="container-custom relative z-10 text-white py-8">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                Trusted Family & Cosmetic Dentist in Colorado Springs
              </h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 items-center">
      ...
      <div className="order-1">
        ...
        <div className="flex flex-wrap gap-3 md:gap-4">
          ...
          <a href="tel:7193542900" className="inline-flex items-center gap-1.5 md:gap-2 bg-gray-100 text-gray-700 px-4 md:px-6 py-2 md:py-3 rounded-lg md:rounded-xl font-semibold text-xs sm:text-sm md:text-base hover:bg-gray-200 transition-all">
            <FaPhone className="text-[#01d09e] text-sm md:text-lg" />
            <span>(719) 354-2900</span>
          </a>
        </div>
      </div>
  ...
  <div className="relative bg-white rounded-xl md:rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg md:shadow-xl border border-gray-100">
    ...
    <div className="text-center mt-16">
      ...
      <p className="text-gray-500 mt-4 text-sm">
        ...
        {/* About the Dentist - Newspaper Style Design */}
<section className="py-12 md:py-16 bg-gray-50 relative overflow-hidden">
  ...
  <div className="container-custom px-4 md:px-6">
    ...
    <div className="text-center mb-8 md:mb-12 relative">
      <div className="inline-block border-t-2 border-b-2 border-[#0194d0] px-6 py-2">
        <span className="text-[#0194d0] font-serif text-sm uppercase tracking-[0.3em]">The Dental Times</span>
      </div>
      <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mt-4 mb-2">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-12">
      {/* Left Column - Doctor's Photo (Newspaper Style) */}
      <div className="lg:col-span-5">
        <div className="sticky top-24">
          {/* Photo with Newspaper Cutout Effect */}
          <div className="relative group">
            {/* Decorative Newspaper Elements */}
            <div className="absolute -top-3 -left-3 w-12 h-12 bg-[#0194d0]/10 rounded-full blur-xl"></div>
            <div className="absolute -bottom-3 -right-3 w-16 h-16 bg-[#01d09e]/10 rounded-full blur-xl"></div>
            
            {/* Main Photo Container */}
            <div className="relative bg-white p-3 shadow-2xl rotate-1 hover:rotate-0 transition-all duration-500">
              {/* Photo Frame with Newspaper Style */}
<div className="relative w-full max-w-[400px] mx-auto">
  <div className="relative group bg-white p-3 shadow-2xl rotate-1 hover:rotate-0 transition-all duration-500">
    ...
    <div className="relative w-full aspect-[2/3] overflow-hidden border border-gray-200">
      <Image
        src="/sh-doc.webp"
        alt="Dr. Juan L. Rodriguez - Lead Dentist"
        fill
        sizes="(max-width: 768px) 100vw, 50vw"
        className="object-contain object-center grayscale-[20%] hover:grayscale-0 transition-all duration-700"
        priority
      />
      {/* Vintage Overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent"></div>
              ...
              <div className="mt-3 text-center border-b border-dashed border-gray-300 pb-2">
                <p className="font-serif text-sm text-gray-600 italic">
                  Dr. Juan L. Rodriguez, DDS, MPH, MS
                </p>
                <p className="text-xs text-gray-400">Staff Photograph • 2024</p>
              </div>
            </div>

            {/* Newspaper Price Tag */}
            <div className="absolute -bottom-4 -right-4 bg-[#0194d0] text-white px-4 py-2 rounded-full shadow-xl transform rotate-3 hover:rotate-0 transition-all">
              <span className="font-serif text-sm font-bold">Vol. 1 • No. 1</span>
            </div>
          </div>

          {/* Quick Facts Box (Newspaper Sidebar) */}
          <div className="mt-6 bg-white/80 backdrop-blur-sm p-4 rounded-lg border-l-4 border-[#0194d0] shadow-md">
            <h3 className="font-serif font-bold text-gray-900 mb-2 text-sm uppercase tracking-wider">At a Glance</h3>
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">DDS, MPH, MS</p>
              </div>
              <div>
                <span className="text-gray-500">Specialty:</span>
                <p className="font-semibold text-gray-900">General Dentistry</p>
              </div>
              <div>
                <span className="text-gray-500">Family:</span>
                <p className="font-semibold text-gray-900">Married, 3 Kids</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Right Column - Newspaper Article Content */}
      <div className="lg:col-span-7 space-y-6">
        {/* Headline */}
        <div className="border-b-2 border-gray-200 pb-4">
          <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
            Dr. Juan L. Rodriguez
            <span className="block text-xl md:text-2xl text-[#0194d0] font-serif mt-2">DDS, MPH, MS</span>
          </h1>
        </div>

        {/* Byline */}
        <div className="flex items-center gap-3 text-sm text-gray-500 border-b border-gray-200 pb-4">
          <span className="font-serif italic">By The Dental Times Staff</span>
          <span className="w-1 h-1 bg-gray-300 rounded-full"></span>
          <span>Published: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</span>
        </div>

        {/* Article Content - Newspaper Columns */}
        <div className="space-y-6 font-serif text-gray-700 leading-relaxed">
          {/* First Paragraph - Drop Cap */}
          <div className="relative">
            <span className="float-left text-6xl font-bold text-[#0194d0] mr-3 mt-2 font-serif">D</span>
        ...
        {/* Credentials Grid (Newspaper Classifieds Style) */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-8 pt-6 border-t-2 border-gray-200">
          <div className="bg-gray-100 p-3 rounded text-center transform hover:scale-105 transition-transform">
            <span className="block text-xs text-gray-500">Degree</span>
            <span className="font-serif font-bold text-[#0194d0]">DDS</span>
          </div>
          <div className="bg-gray-100 p-3 rounded text-center transform hover:scale-105 transition-transform">
            <span className="block text-xs text-gray-500">Master's</span>
            <span className="font-serif font-bold text-[#01d09e]">MPH</span>
          </div>
          <div className="bg-gray-100 p-3 rounded text-center transform hover:scale-105 transition-transform">
            <span className="block text-xs text-gray-500">Master's</span>
            <span className="font-serif font-bold text-[#0194d0]">MS</span>
          </div>
        </div>
        ...
        <div className="text-center mt-4">
          <Link 
            href="/about" 
            className="inline-flex items-center gap-2 text-[#0194d0] font-medium hover:text-[#017ab0] transition-colors group"
          >
...
<section className="py-8 md:py-8 bg-white relative overflow-hidden">
        ...
        <section className="py-10 bg-[#0194d0] rounded-lg ">
          <div className="container-custom text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:7193542900" className="btn-secondary bg-[#0194d0] hover:bg-navy-900 text-white border-white border-3 text-lg px-8 py-4">
  ...
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2560.3761802505064!2d-104.68379292499232!3d38.868449148413255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x871347df3246f707%3A0xdd76d1ec04f8ce4e!2sSand%20Hill%20Dental%20Care!5e1!3m2!1sen!2sin!4v1771409965119!5m2!1sen!2sin"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">7903 Silicon Heights, <br />Colorado Springs, CO, USA</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <a href="tel:7193542900" className="text-gray-600 hover:text-blue-500">(719) 354-2900</a>
                    </div>
                  </div>
